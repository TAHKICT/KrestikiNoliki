...
<head>
    ...
    <script>
        xmlhttp.open("POST","gameontroller",true);
        xmlhttp.setRequestHeader("Content-type","application/x-www-form-urlencoded");
        xmlhttp.send("name=<%=userName%>&sessionUrl=window.location.pathname");
    </script>
    <title></title>
</head>
<body>
...
<form action="gamecontroller" method="post">
    ...
    <input type="text" name="sessionUrl" value=<script>window.location.pathname</script>>
